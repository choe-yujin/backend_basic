package com.metaverse.inheritance.chap01.section03;

/*

📌 상속 매핑 전략 설명
JPA는 객체지향의 상속을 데이터베이스에 매핑하기 위해 3가지 전략을 제공한다:
SINGLE_TABLE: 모든 클래스를 하나의 테이블에 저장. DTYPE 컬럼으로 클래스 구분.
JOINED: 부모와 자식 클래스를 각각 테이블로 나누고, 조인으로 연결.
TABLE_PER_CLASS: 각 클래스를 별도의 테이블로 저장.
*
📌 실생활 비유
...
import com.metaverse.inheritance.chap01.section02.model.ClothingProduct;
import com.metaverse.inheritance.chap01.section02.model.ElectronicProduct;
import com.metaverse.inheritance.chap01.section02.model.FoodProduct;
import com.metaverse.inheritance.chap01.section02.model.Product;
...
public class Application {
    public static void main(String[] args) {
        ...
        try {
            ...
            powerConsumption
            */
            ElectronicProduct electronic = new ElectronicProduct(null, "Laptop", 1000, "TechBrand", 50, 24, "65W");
            ...
            material :
            */
            ClothingProduct clothing = new ClothingProduct(null, "T-Shirt", 20, "FashionBrand", 100, "M", "Cotton", "Blue");
            em.persist(clothing);
            ...
            */
            FoodProduct food = new FoodProduct(null, "Milk", 3, "FoodBrand", 200, LocalDate.now().plusDays(7), true, "Refrigerate at 4°C");
            em.persist(food);
